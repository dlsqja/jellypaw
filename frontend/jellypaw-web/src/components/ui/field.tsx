...
function FieldLabel({ className, ...props }: React.ComponentProps<typeof Label>) {
  return (
    <Label
      ...
      className={cn(
        'group/field-label peer/field-label p2-b text-aqua-500 flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50',
...
function FieldDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return <p data-slot="field-description" className={cn('text-aqua-500 caption1 text-right', className)} {...props} />;
}
